      ...
      <div>
        ...
        {/* <div class="row">
          <div class="col-12 mb-20">
            <h3>
              <FormattedMessage id="booking-history.filters" />
            </h3>
          </div>
          <div class="col-12 mb-5">
            <span style={{ width: "100px", display: "inline-block" }}>
              <FormattedMessage id="booking-history.from-date" />
            </span>
            <input
              type="date"
              class="ml-5"
          ...
          <div class="col-12">
            <span style={{ width: "100px", display: "inline-block" }}>
              <FormattedMessage id="booking-history.to-date" />
            </span>
            <input
              type="date"
              class="ml-5"
          ...
          <div class="col-12 mt-10">
            ...
            >
              <FormattedMessage id="booking-history.apply" />
            </button>
            <button
              type="button"
            ...
            >
              <FormattedMessage id="booking-history.reset" />
            </button>
          </div>
        </div> */}
